									...
									case 'message':
											switch (operation) {
													case 'send':
															...
															console.log('Raw buttons parameter:', JSON.stringify(buttons, null, 2));
															console.log('Button layout:', buttonLayout);
															console.log('Processed button rows:', JSON.stringify(buttonRows, null, 2));
													...
													case 'update':
															...
															console.log('=== UPDATE MESSAGE DEBUG ===');
															console.log('Raw update buttons parameter:', JSON.stringify(updateButtons, null, 2));
															console.log('Update button layout:', updateButtonLayout);
															console.log('Processed update button rows:', JSON.stringify(updateButtonRows, null, 2));
